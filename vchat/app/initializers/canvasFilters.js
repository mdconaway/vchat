//Reference: https://github.com/kig/canvasfilters
//for additional information
//
//Michael Conaway added "sepia" filter
export function initialize(registry, application){
    ...
    Filters.sepia = function(pixels, args) {
      var intensity = args && args > 0 ? parseFloat(args) : 1;
    ...
    registry.register('services:filters', Filters, {instantiate: false});
    application.inject('component', 'filters', 'services:filters');
}
